...
// Add this with other DOM element declarations (around line 20-30 in your file)
...
staffLoginBtn.addEventListener('click', () => openLoginModal('staff'));
adminLoginBtn.addEventListener('click', () => openLoginModal('admin'));
closeBtn.addEventListener('click', closeLoginModal);
loginForm.addEventListener('submit', handleLogin);
studentMenuBtn.addEventListener('click', () => toggleStudentSection('menu'));
studentCartBtn.addEventListener('click', () => toggleStudentSection('cart'));
studentLogoutBtn.addEventListener('click', logout);
staffOrdersBtn.addEventListener('click', () => toggleStaffSection('orders'));
staffMenuBtn.addEventListener('click', () => toggleStaffSection('menu'));
staffLogoutBtn.addEventListener('click', logout);
adminMenuBtn.addEventListener('click', () => toggleAdminSection('menu'));
adminUsersBtn.addEventListener('click', () => toggleAdminSection('users'));
...
// Load menu items for staff
function loadStaffMenuItems() {
    database.ref('menu').on('value', snapshot => {
...
// COMPLETELY REPLACE the existing loadUsers() function with this:
function loadUsers() {
    ...
    database.ref('users').once('value')
        .then(snapshot => {
            ...
            snapshot.forEach(childSnapshot => {
              ...
              <span class="delete-user" data-id="${childSnapshot.key}">&times;</span>
            `;
